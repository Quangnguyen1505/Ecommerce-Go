...
const TableNameGoCrmUserV2 = "go_crm_userv2"
...
type GoCrmUserV2 struct {
	...
	UsrStatus      int16  `gorm:"column:usr_status;not null;comment:Status 1:enable, 0:disable, -1:deleted" json:"usr_status"` // Status 1:enable, 0:disable, -1:deleted
}
